...
::blockText
---
title: Information sur l’environnement de travail
subtitle: 
textContent: "
-Vercel pour la phase de test <br/>
-Environnement de dev, release et prod<br/>
-Développement des pages et templates<br/>
-Méthode agile avec des sprints de 2semaines gerer avec l’application JIRA<br/>
"
---
::
::blockText
...
-Développement du listing de périodes offerte<br/>
"
---
::
::slider
...
subtitle: "Le dashboard: Plateforme de gestion du produit mise à disposition pour le client. Utilisations des outils et produit marketing, imports et exports de données, administration des utilisateurs, merchants,produits."
textContent: "
-Rebranding du site<br/>
-Refactorisation des pages du site vers l’utilisation des compositions api, typescript et script setup<br/>
-Ajouts du composant paginations<br/>
-Amélioration de la création de jeu concours et du listing<br/>
-Développement d’une nouvelle homepage pour les utilisateurs autonome.<br/>
-Développement des previews des différents templates, blocs d’actions proposé, bloc d’aide et de suivie.<br/>
"
---
::
::slider
...
subtitle: "Jeu concours: Pluggin pour permettre au merchant de proposer un jeu de roulette pour gagner des prix. Peut être connecté aux avis googles"
textContent: "
-Gestions des erreurs<br/>
-Interface du choix du magasin et search bar<br/>
-Gestion de la fréquences d’utilisation du jeu concours<br/>
"
---
::
::landingPage
...
-Développement du composable<br/>
-Réfactorisation en composant api<br/>
"
---
::
