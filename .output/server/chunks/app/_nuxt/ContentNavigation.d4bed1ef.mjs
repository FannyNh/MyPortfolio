import { d as useNuxtApp, e as useState, f as useContentDisabled, g as useAsyncData, w as withContentBase, b as addPrerenderPath, j as jsonStringify, u as useCookie, _ as _export_sfc, c as useHead, h as __nuxt_component_0$1 } from '../server.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "circles absolute h-screen fixed min-w-full flex justify-between items-center" }, _attrs))} data-v-831d799f><div id="research" class="circle research" data-v-831d799f></div><div id="design" class="circle design" data-v-831d799f></div></div>`);
}
const _sfc_setup$2 = _sfc_main$2.setup;
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/LayoutBackgroundProjects.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const LayoutBackgroundProjects = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-831d799f"]]);
const LayoutBackgroundProjects$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: LayoutBackgroundProjects
...
defineAsyncComponent(() => import('./BlockText.351f642a.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./Card.10dae511.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./Description.b77e971b.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./Slider.712e20f4.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./TagsList.393ed386.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('../server.mjs').then((n) => n.A).then((c) => c.default || c));
defineAsyncComponent(() => import('./AppNavbar.d884a701.mjs').then((n) => n.A).then((c) => c.default || c));
defineAsyncComponent(() => import('./AppNavbar.d884a701.mjs').then((n) => n.a).then((c) => c.default || c));
defineAsyncComponent(() => import('./AppNavbar.d884a701.mjs').then((n) => n.c).then((c) => c.default || c));
defineAsyncComponent(() => import('./AppNavbar.d884a701.mjs').then((n) => n.b).then((c) => c.default || c));
defineAsyncComponent(() => import('./LayoutBackgroundDefault.2ccc7e6c.mjs').then((c) => c.default || c));
defineAsyncComponent(() => Promise.resolve().then(() => LayoutBackgroundProjects$1).then((c) => c.default || c));
defineAsyncComponent(() => import('./AppNavbar.d884a701.mjs').then((n) => n.B).then((c) => c.default || c));
defineAsyncComponent(() => import('../server.mjs').then((n) => n.t).then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentList.9306c649.mjs').then((c) => c.default || c));
...
defineAsyncComponent(() => import('./ContentSlot.0a51be70.mjs').then((c) => c.default || c));
...
defineAsyncComponent(() => import('./Markdown.dcb3b851.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseA.e459e900.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseBlockquote.18c20ca1.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseCode.bbedd0f4.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseCodeInline.cd046a03.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseEm.9ee7213e.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH1.9622a8bd.mjs').then((c) => c.default || c));
...
defineAsyncComponent(() => import('./ProseH5.cb354057.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH6.67292785.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseHr.3741cc5b.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseImg.4debdb73.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseLi.8a94de2e.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseOl.f6075324.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseP.f8df84d8.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseStrong.a3981451.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTable.71e474bd.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTbody.f2f29787.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTd.e7d2e285.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTh.8635a3bf.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseThead.fb103e46.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTr.3f4de13f.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseUl.30896169.mjs').then((c) => c.default || c));
...
//# sourceMappingURL=ContentNavigation.d4bed1ef.mjs.map
