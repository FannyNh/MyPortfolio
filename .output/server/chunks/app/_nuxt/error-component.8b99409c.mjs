...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404.f9767c23.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500.dd37182f.mjs'));
...
//# sourceMappingURL=error-component.8b99409c.mjs.map
