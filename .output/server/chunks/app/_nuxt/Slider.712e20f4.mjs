            ...
            ssrRenderList(__props.images, (image) => {
              _push2(ssrRenderComponent(unref(SplideSlide), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<img${ssrRenderAttr("src", `/assets/images/${image.src}`)}${ssrRenderAttr("alt", image.alt)}${_scopeId2}>`);
                  } else {
                    return [
                      createVNode("img", {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/content/Slider.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=Slider.712e20f4.mjs.map
